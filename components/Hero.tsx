    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight mb-10"
        >
        ...
        <motion.p
          ...
          className="max-w-xl mx-auto text-neutral-500 mb-12 leading-relaxed"
        >
          {t.hero.description}
        </motion.p>
